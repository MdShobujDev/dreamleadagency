...
export const metadata = { title: "Influencer Leads" };
    ...
    <div className="py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Influencer Leads</h1>
          <p className="text-slate-400 text-lg leading-relaxed">
            High-quality influencer leads tailored to your ideal customer profile.
